...
TEST(StringUtilsTest, Split){
    ...
    std::cout<<SentenceComponents[0]<<std::endl;
    std::cout<<SentenceComponents[1]<<std::endl;
    std::cout<<SentenceComponents[2]<<std::endl;
    std::cout<<SentenceComponents[3]<<std::endl;
